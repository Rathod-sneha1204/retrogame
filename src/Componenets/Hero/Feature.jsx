...
import maxresdefault from "../../assets/image/maxresdefault.jpg";

const Features = () => {
  return (
    <section className="bg-[#b399ff] bg-opacity-55 flex justify-center mx-auto mt-6 w-full max-w-[1400px] rounded-3xl py-8">
      <div className="max-w-10xl mx-auto flex flex-col md:flex-row items-center justify-center gap-16 p-14 ">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <p className="text-gray-700 text-lg">
            ...
            Facebook, Instagram, LinkedIn, Threads, and more.
          </p>
          ...
          <div className="space-y-3 text-gray-800">
            <div className="flex items-center gap-2">
              ...
              <p>Auto-publish or get notified when it’s time to post</p>
            </div>
            <div className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>Magically customize your post for each platform</p>
            </div>
            <div className="flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p>See everything scheduled in calendar or queue view</p>
            </div>
          </div>
